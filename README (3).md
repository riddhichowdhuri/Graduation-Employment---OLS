...
├── reproduce_and_plot.py         # Python reproduction (no Stata license needed) — regenerates the plots
├── regression_summary.md         # results as formatted tables
└── graphs (graph_*.png, resid_vs_*.png) — residual diagnostics + GURY-vs-regressor plots
```
